 ...
 *	请把该js引入在body标签内
 *	否则会报以下错误信息：
 *	notie.js:202 Uncaught TypeError: Cannot read property 'appendChild' of null.
 *
 *	模板：
 *	notie.alert(1, '成功了!', 1);
 *	notie.alert(2, '警告<br><b>with</b><br><i>HTML</i><br><u>included.</u>', 2);
 *	notie.alert(3, '错误.', 2);
 *	notie.alert(4, '这里填写信息.', 2);
 *
 *	用于确认操作
 *	notie.confirm('你确定要这样做吗?<br><b>这是一个大胆的选择</b>', '确认', '取消', function() {
 *		location.href="#";
 *  });
 *  
 *  弹框并输入且带提示
 *  notie.input('请输入您的邮箱地址:', '提交', '取消', '邮箱', 'name@example.com', function(value) {
 *		notie.alert(1, '您输入的是: ' + value, 2);
 *	});
 *  
*/
