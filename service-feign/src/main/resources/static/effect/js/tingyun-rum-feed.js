var TINGYUN = function(t, e, n) {
    ...
    function a(t) {
        ...
        case "object":
            if (!t) return null;
            if (t instanceof Array) return i(t,
            function(e, n) {
                t[n] = a(e)
            }),
            "[" + t.join(",") + "]";
    ...
    function d(t) {
        return arguments.length < 2 || !t ? t: (i(Ut.call(arguments, 1),
        function(e) {
            i(e,
            function(e, n) {
                t[n] = e
    ...
    function O() {
        ...
        function(t) {
            Dt(e, t,
            function(e) {
                R(function() { (Ce.e[t] || (Ce.e[t] = [])).push(m())
                }),
                Ne.emit(t, e)
            })
        });
        var t = y(function() {
            ...
            Le.domContentLoadedEventStart = t,
            $t.querySelectorAll && (Re.resources = Re.resources || [], i($t.querySelectorAll("head>link,head>script"),
            function(t) {
                var e;
                "LINK" == t.tagName ? e = t.href: "SCRIPT" != t.tagName || t.defer || t.async || (e = t.src),
                e && Re.resources.push(e)
            }))
        });
        Dt($t, "DOMContentLoaded", t),
        Dt($t, pe,
        function(e) {
            $t.readyState === ve && t()
        });
        ...
        i(["scroll", "click", "keypress"],
        function(t) {
            s($t, t, n)
        });
        var r = e.requestAnimationFrame; ! r || r.toString().indexOf("[native code]") < 0 || I(e, "requestAnimationFrame",
        function(t) {
            return function() {
                if (!Le.firstPaint) {
                    var n = m();
    ...
    function M(t, e) {
        this.flags = 0,
        At(t.create) && (this.create = t.create, this.flags |= Fe),
        At(t.before) && (this.before = t.before, this.flags |= Pe),
        At(t.after) && (this.after = t.after, this.flags |= Ue),
        At(t.error) && (this.error = t.error, this.flags |= Ye),
        this.data = e
    }
    function j(t, e) {
        if (!Ge) {
    ...
    function z(t) {
        ...
        return function __ty_aysncWrap__() {
            ...
            try {
                ...
                throw 0 != (Ge.flags & Ye) && Ge.error(e, i),
                i
            }
            return 0 != (Ge.flags & Ue) && Ge.after(this, e),
            r
        }
    }
    function D(t) {
    ...
    function X(t) {
        ...
        this.key = t.key;
        var e = t.timeout || 6e5;
        this.i = e ? setTimeout(f(this.fail, this), e) : null,
        this.status = 1,
        this.remain = 0,
        this.xhrs = [],
        this.s = m(),
    ...
    function G() {
        if (Object.defineProperty) {
            ...
            Object.defineProperty(e, be, {
                get: function() {
                    return nn++>0 && e.console && console.warn("window.%s is deprecated, use window.%s instead.", be, Se),
                    t
                }
            })
        }
    ...
    function K(t) {
        ...
        if (t) {
            ...
            Le._le = o.ue || o.le;
            var p, v;
            if (t.msFirstPaint) p = t.msFirstPaint,
            R(function() {
                Ce.fp = "m_" + p
            });
            else if ((v = e.chrome) && v.loadTimes) {
                var g = v.loadTimes();
                g && g.firstPaintTime && (p = 1e3 * g.firstPaintTime),
                R(function() {
            ...
            p && (o.fp = Math.round(p - a), Le.fp = o.fp),
            t[_n] && (o.sl = r(_n))
        } else o = {
            t: a,
            os: J() - a,
        ...
        return o.je = Le.errs && Le.errs.length || 0,
        Le.ct && (o.ct = Le.ct - a),
        Le.touch && (o.fi = Le.touch - a),
        o
    }
    function Q(t, e) {
        var r = {
        ...
        function(t, r) {
            var i = t.toObject();
            i.o = i.o - e && e.navigationStart || n,
            o[r] = i
        }),
        r.err = o;
        var a = "getEntriesByType";
        return t[a] ? (r.tr = !0, r.res = [], i(t[a]("resource"),
        function(t) {
            function e(e) {
                var n = t[e];
                return n > 0 ? n: 0
    ...
    function tt(t) {
        var e = 0,
        n = t.timing;
        return n ? t.getEntriesByName && (e = n.domLoading, i(Re.resources,
        function(r) {
    ...
    function et(t, n, r, o) {
        ...
        if (u && u.length && t.getEntriesByName) return i(u,
        function(e) {
    ...
    function ut(t) {
        var e = n,
        r = 0;
        return t && (e = t.navigationStart || e, r = t[sn] || t.domInteractive || t.domLoading || r),
        (r = Le[sn] || r || Le._end) - e
    }
    function st(t) {
        if (t) {
    ...
    function ft(t) {
        return function __ty_aysncWrap__(e) {
            ...
            if (r._ && (r._ = 1), !n[_e]) {
                var i = n[be];
                i && (i.start = m(), i.reqSize = b(e)),
                lt(n),
                n.setRequestHeader && Vt.id && i && On(i.url) && (i.r = m() % 1e9, n.setRequestHeader("X-Tingyun-Id", Vt.id + ";r=" + i.r))
            }
            try {
        ...
        function e(e) {
            return D(function __ty_aysncWrap__() {
                ...
                if (At(e)) {
                    ...
                    i && 4 == t.readyState && (i.cbTime = m() - o, t[be] = null)
                }
                return r
            })
        }
    ...
    function dt(t) {
        ...
        if (e && (e.end = m(), e.readyState = t.readyState, 4 == t.readyState)) {
            ...
            v(function() {
                ...
                if (i(In,
                function(t) {
                    if (t.id === e.id) return r = !0,
                    !1
                }), !r) {
                    var o = pt(e, t);
                    n && n.key == e.key && (n.xhrs.push(o), 0 == --n.remain && n._end()),
                    Le.xhrs && (Cn(e), Le.xhrs[e.url] = o),
                    In.push(o)
                }
            })
        }
    ...
    function Ct() {
        ...
        return t ? Tt() : Dt(e, ce,
        function(t) {
            var n, r, i, o, a; (t instanceof e.Event || e.ErrorEvent && t instanceof e.ErrorEvent) && (n = t.message || t.error && (t.error.message || t.error.constructor.name) || "", r = t.lineno || 0, i = t.colno || 0, (o = t.filename || t.error && t.error.filename || t.target && t.target.baseURI || "") == $t.URL && (o = "#"), a = t.error),
            Et(n, o, r, i, a)
        }),
        Ne.on([fe, le, de, he],
        function(t) {
    ...
    _.prototype = {
        on: function(t, e) {
            var n = this;
            return qt(t) ? (n.events[t] || (n.events[t] = [])).push(e) : Ot(t) && i(t,
            function(t) {
                n.on(t, e)
            }),
            n
    ...
    function() {
        function t() {
            ...
            (o = 0 === c.getClientRects().length) && (c.style.display = "", c.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", (t = c.getElementsByTagName("td"))[0].style.cssText = "margin:0;border:0;padding:0;display:none", (o = 0 === t[0].offsetHeight) && (t[0].style.display = "", t[1].style.display = "none", o = 0 === t[0].offsetHeight)),
            l.removeChild(s)
        }
        $t.documentElement;
    ...
    e.XDomainRequest ? se = function(t, e, n, r) {
        ...
        At(n) && (r = n, n = null),
        ne.sendBeacon(t, Nt(e)) && r && r()
    }: se = function(t, e, n, r) {
        At(n) && (r = n, n = null);
        var i = y(r),
        o = new Kt;
        o[_e] = !0,
        o.overrideMimeType && o.overrideMimeType("text/html"),
        o.onreadystatechange = function() {
    ...
    function() {
        if (te) {
            ...
            Ht($t.hidden) ? Ht($t.msHidden) ? Ht($t.webkitHidden) || (t = "webkitHidden", e = "webkit" + n) : (t = "msHidden", e = "ms" + n) : (t = "hidden", e = n),
            Ht($t.addEventListener) || Ht($t[t]) || Dt($t, e, N(function() {
    ...
    Ae = B.prototype;
    Ae.start = function() {
        if (!Vt.key) return A("missing config, agent disabled!"),
        !1;
        var t = e[be] || e[Se];
    ...
    Le.on("send",
    function(t, e, n, r) {
        var i = x(Vt.beacon, t, d({},
        He, e || {}));
        switch (r = r || g, t) {
        case "/pf":
            n ? se(i, n,
            function() {
                Le.xhrs = Le.errs = null,
                r()
            }) : Te(i, r);
            break;
        default:
    ...
    en = {
        ...
        config: function(t, e) {
            ...
            if (Lt(t)) n = t;
                ...
                if (!qt(t) || e === undefined) throw new Jt(je); (n = {})[t] = e
            }
            return i(n,
            function(t, e) {
        ...
        diagnose: function(t) {
            ...
            var n = {},
            r = A();
            if (e("Status", r, "ok" !== r), e("Debug", L()), i(ze,
            function(t, n) {
        ...
        addExcludedDomain: function(t) {
            ...
            function(t) {
                if (t) {
                    if (! (t instanceof RegExp)) throw new Jt("parameter's type requires RegExp"); (Qt.domains || (Qt.domains = [])).push(t)
                }
            })
        }
    };
    ...
    var En = function() {
        var t = y(function() {
            ...
            c = d({},
            Ve);
            Le.fp ? (c.fp = Le.fp, o && Le.fp > Le._le && (L("fp>le"), c.fp = tt(r), c.__fp = 2)) : o ? (c.fp = tt(r), c.__fp = 1) : c.fp = c.__fp = 0,
            c.dr = ut(u),
            o ? c.fs = et(r, u, c.fp, c) : c.__fs = 0;
            var f, l = "";
            if (o) {
                var h = Math.max(s.ls, 0);
                h || (h = $() - u.navigationStart || n),
                c.trace = h;
                var v = st(u);
                i(["fp", "fs", "dr", "trace"],
                function(e) {
                ...
                delete c.trace,
                l.indexOf("1") > -1 && (f = Q(r, u))
            }
            c.trflag = l || "0000",
            Re.pfStart = m(),
            delete s.firstScreenResources,
            delete s.resources,
            Le.emit("send", "/pf", d(s, c), f,
            function() {
                L("pf sent!"),
                Le.xhrs = Le.errs = null
            })
    ...
    Cn = kn.length ?
    function(t) {
        var e = t.url; ! Le.ct && e && i(kn,
        function(n) {
            if (e.match(n)) return Le.ct = t.end + t.cbTime,
            !1
        })
    }: g,
    In = [],
    ...
    return _t.prototype = {
        ...
        fix: function() {
            ...
            if (e && qt(e)) {
                var n = [];
                i(e = e.split(/\n/),
                function(t, e) { - 1 == t.indexOf("__ty_aysncWrap__") && n.push(t)
                }),
                t.stack = n.join("\n")
            }
        },
