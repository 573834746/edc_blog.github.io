!function() {
    ...
    e.dom._styleFilter.filter = function(t, n, o) {
        for (var i, r = 0,
        a = e.dom._styleFilter; i = a[r]; r++)(i = i[o]) && (n = i(t, n));
        return n
    },
    e.string = e.string || {},
    e.string.toCamelCase = function(e) {
        return String(e).replace(/[-_]\D/g,
        function(e) {
    ...
    e.dom.getStyle = function(t, n) {
        ...
        return i = "object" == typeof r && r.get ? r.get(t, a) : a[r || n],
        (r = o._styleFilter) && (i = r.filter(n, i, "get")),
        i
    },
    ...
    e.dom.getPosition = function(t) {
        ...
        if (t == a) return r;
        var l, s = null;
        if (t.getBoundingClientRect) l = t.getBoundingClientRect(),
        ...
        o.ie && !o.isStrict && (r.left -= 2, r.top -= 2);
            ...
            r.left = l.screenX - u.screenX,
            r.top = l.screenY - u.screenY
        } else {
            s = t;
            do {
                if (r.left += s.offsetLeft, r.top += s.offsetTop, o.isWebkit > 0 && "fixed" == e.dom.getStyle(s, "position")) {
                    r.left += n.body.scrollLeft,
                    r.top += n.body.scrollTop;
                    break
                }
                s = s.offsetParent
            } while ( s && s != t );
            for ((o.opera > 0 || o.isWebkit > 0 && "absolute" == e.dom.getStyle(t, "position")) && (r.top -= n.body.offsetTop), s = t.offsetParent; s && s != n.body;) r.left -= s.scrollLeft,
            b.opera && "TR" == s.tagName || (r.top -= s.scrollTop),
            s = s.offsetParent
        }
        return r
    },
    ...
    e.event._unload = function() {
        for (var t, n, o = e.event._listeners,
        i = o.length,
        r = !!window.removeEventListener; i--;) t = o[i],
        n = t[0],
        n.removeEventListener ? n.removeEventListener(t[1], t[3], !1) : n.detachEvent && n.detachEvent("on" + t[1], t[3]);
    ...
    e.event.on = function(t, n, o) {
        n = n.replace(/^on/i, ""),
        "string" == typeof t && (t = e.dom.g(t));
        var i = function(e) {
            o.call(t, e)
        },
        r = e.event._listeners;
        return r[r.length] = [t, n, o, i],
        t.attachEvent ? t.attachEvent("on" + n, i) : t.addEventListener && t.addEventListener(n, i, !1),
        t
    },
    e.on = e.event.on,
    ...
    function() {
        ...
        n = function(e) {
            ...
            e.listen = function(n, o) {
                ...
                return i == t[n].length && t[n].push(o),
                e
            },
            e.call = function(n) {
    ...
    e.ui.suggestion._Div = function(t, n, o, i, r) {
        function a(e, n) {
            if ("none" == w.style.display) return void t.call("need_data", o.getValue());
            var i = s()[0];
            if (l(), e) {
                if (0 == i) return c(n),
                void i--;
        ...
        function l() {
            for (var e = 0; e < y.length; e++) y[e].className = b + "ml"
        }
        function s() {
            if (y && "none" != w.style.display) for (var e = 0; e < y.length; e++) if (y[e].className == b + "mo") return [e, p[e], m[e]];
            return [ - 1, ""]
        }
        function u() {
            var e = s();
        ...
        function f() {
            return "none" == w.style.display ? null: (_.style.display = w.style.display = "none", void r.onhide())
        }
        function g(e) {
            var n = e;
            return function() {
                ...
                var e = o.getValue();
                c(p[n]),
                r.onpick(e, n, p[n], m[n]),
                r.onconfirm(o.getValue(), n, p[n], m[n]),
                f()
            }
        }
        var p, m, v, y, h = this,
        ...
        w.id = b + (new Date).getTime(),
        w.className = b + "wpr",
        w.style.display = "none";
        var _ = document.createElement("IFRAME");
        return _.className = b + "sd",
        _.style.display = "none",
        _.style.position = "absolute",
        _.style.borderWidth = "0px",
        r.apd_body ? document.body.appendChild(w) : n.parentNode.appendChild(w),
        w.parentNode.insertBefore(_, w),
        t.listen("start",
        function() {
            e.on(document, "mousedown",
            function(e) {
                e = e || window.event;
                var t = e.target || e.srcElement;
                if (t != n) {
                    for (; t = t.parentNode;) if (t == w) return;
                    f()
                }
            }),
            e.on(window, "blur", f)
        ...
        function() {
            var e = s(),
            t = e[0] == -1 ? v: e[1];
            r.onconfirm(o.getValue(), e[0], t, e[2], !0),
            f()
        }),
        t.listen("key_up",
        function(e) {
        ...
        function(n, o) {
            ...
            m = [];
            for (var r = 0,
            a = o.length; r < a; r++)"undefined" != typeof o[r].input ? (p[r] = o[r].input, m[r] = o[r].selection) : m[r] = p[r] = o[r];
            if (0 != p.length) {
                y = i(w, m, h);
                for (var r = 0,
                a = y.length; r < a; r++) e.on(y[r], "mouseover",
                function() {
                    l(),
                    this.className = b + "mo",
                    u()
                ...
                e.on(y[r], "mousedown",
                function(n) {
                    if (t.call("mousedown_item"), !e.ie) return n.stopPropagation(),
                    n.preventDefault(),
                    !1
                }),
                e.on(y[r], "click", g(r))
    ...
    e.ui.suggestion._Data = function(e, t) {
        var n = {};
        return e.listen("response_data",
        function(t, o) {
            n[t] = o,
            e.call("data_ready", t, o)
        }),
        e.listen("need_data",
        function(o) {
    ...
    e.ui.suggestion._InputWatcher = function(t, n, o) {
        ...
        c = !1,
        f = !1;
        return n.setAttribute("autocomplete", "off"),
        e.on(n, "keydown",
        function(n) {
            f || (t.call("start"), f = !0),
            n = n || window.event;
    ...
    e.ui.suggestion._Suggestion = function(t, n) {
        ...
        o._adjustPos = function(n) {
            ...
            if ("none" != i.style.display || !n) {
                ...
                f = [c.top + t.offsetHeight - 1, c.left, t.offsetWidth];
                ...
                u == s.clientHeight && d == s.clientWidth || o._adjustPos()
            }
        },
        o._draw = function(e, t) {
            ...
            d.className = o.options.class_prefix + "pre",
            d.innerHTML = o.options.prepend_html;
            var c = document.createElement("DIV");
            return c.className = o.options.class_prefix + "app",
...
var BaiduSuggestion = function() {
    ...
    function t(e, t, a, d) {
        if (e) {
            ...
            if ("relative" == r(document.body, "position") || "absolute" == r(document.body, "position")) {
                ...
                t.XOffset = (t.XOffset ? parseInt(t.XOffset) : 0) + y.x,
                t.YOffset = (t.YOffset ? parseInt(t.YOffset) : 0) + y.y
            }
            s["sug" + e.sugId] = baidu.suggestion.create(e, u.createSugOptions(e.sugId, t, a, d ? n(e) : null)),
            l["give" + e.sugId] = u.createSugCallback(e.sugId)
        }
    }
    function n(e) {
    ...
    function o(e) {
        ...
        } else for (; e = e.offsetParent;) n += e.offsetLeft,
        o += e.offsetTop;
        return {
            x: n,
            y: o
    ...
    function i(e, t) {
        ...
        for (var r = 0; r < n.length; r++) if (!n[r].href) {
            n = n[r];
            break
        }
    ...
    u = {
        createSugOptions: function(t, n, o, i) {
            return {
                ...
                view: function(e) {
                    return n && n.width && (e[2] = parseInt(n.width)),
                    n && n.XOffset && n.YOffset ? [e[0] - n.YOffset, e[1] - n.XOffset, e[2]] : [e[0], e[1], e[2]]
                },
                getData: function(n) {
