!function() {
    ...
    c = {
        ...
        initData: function() {
            ...
            $("meta[name=track]").attr("content") && (t = JSON.parse($("meta[name=track]").attr("content"))),
            t && (n = $.extend({},
            n, t)),
            n
        },
        tos: function() {
            var e, t, o, r;
            e = +new Date / 1e3 | 0,
            o = null != (t = /\bdc_tos=([^;]*)(?:$|;)/.exec(document.cookie)) ? t[1] : void 0;
            try {
                r = e - parseInt(o, 36)
            } catch(e) {
                console.warn("tos init error", e),
                r = -1
            }
            return document.cookie = "dc_tos=" + e.toString(36) + " ; expires=" + new Date(1e3 * (e + 14400)).toGMTString() + " ; max-age=14400 ; path=/ ; domain=." + this.topDomain(window.location.host),
            r
        },
        ...
        getElementTop: function(e) {
            ...
            var t = e.offsetTop;
            for (e = e.offsetParent; null != e;) t += e.offsetTop,
            e = e.offsetParent;
            return t
        },
        url2Obj: function(e) {
    ...
    e = {
        ...
        reportView: function(e, t, o) {
            ...
            delete r.cfg,
            r.type = a.VIEW,
            void 0 === o ? this.reportServerDelay(a.VIEW, r) : this.reportServer(a.VIEW, r),
            "function" == typeof csdn.afterTrackReportView && csdn.afterTrackReportView(t, e)
        },
        ...
        debug: function(e, t) {
            ...
            o = c.url2Obj(JSON.parse(r.body).re),
            void 0 !== t ? console.log(o.type, "--\x3e:", r.headers.datatype, o.mod, o.con) : console.log(o.type, "--\x3e:", o)
        }
    },
    void 0 === window.csdn && (window.csdn = {}),
    window.csdn.track = e,
    (n = c.initData()).disabled || csdn.track.reportPageView()
} (),
$(function() {
    var t = csdn.track;
    $(document).on("click", "[data-track-click]",
    function() {
