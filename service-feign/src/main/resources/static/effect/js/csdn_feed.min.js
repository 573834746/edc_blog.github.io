...
function guanzhu(t) {
    ...
    function(e) {
        1 == e.succ ? t.addClass("followed").text("已关注") : "已关注" === e.msg ? t.addClass("followed").text("已关注") : t.removeAttr("disabled")
    })
}
function prompt() {
    var t = $(".feed-prompt");
    t.each(function(t) {
        ...
        i = $(this).data("loca");
        if (void 0 === i) {
            var n = e.parent().attr("class");
            void 0 !== n.indexOf("read_num") && n.indexOf("read_num") > -1 ? e.css({
                left: "-13px"
            }) : (e.css({
                left: e.parent().outerWidth() / 2 - $(this).outerWidth() / 2
            }), e.data("loca", "1"))
        }
    })
}
function once(t) {
    var e, i;
    if (!isFunction(t)) throw new TypeError(funcErrorText);
    return function() {
...
function refreshTime() {
    ...
    function i(t, e, i, n) {
        return 0 !== t.length && void t.forEach(function(t, a, s) {
            t.data("timenum") < i && t.data("time") === e ? (t.data("timenum", t.data("timenum") + 1), t.text(t.data("timenum") + e + "前")) : t.data("time") === e && n && (t.data("timenum", 0), t.data("time", n.name), n.push(t))
        })
    }
    function n(t, e, i, n, a, s) {
        setInterval(t, e, i, n, a, s)
    }
    var a = this;
    this.total = $(".time a"),
    this.minuteDOM = t("分钟"),
    this.hourDOM = t("小时"),
    this.dayDOM = t("天"),
    this.selectTotal = function() {
        this.total.each(function(t) {
            var i = $(this);
            if (void 0 === i.data("time")) {
                var n = trimStr(i.text());
                if ("刚刚" == n) e(i, a.minuteDOM, 0, "分钟");
                else {
                    var s = parseInt(n);
                    timeText = n.substring(s.toString().length),
                    "分钟前" === timeText ? e(i, a.minuteDOM, s, "分钟") : "小时前" === timeText ? e(i, a.hourDOM, s, "小时") : "天前" === timeText && e(i, a.dayDOM, s, "天")
                }
            }
        })
    },
    ...
    this.hourAdd = i,
    this.dayAdd = i,
    this.setIntervalday = n,
    this.setIntervalHour = n,
    this.setIntervalMinute = n,
    this.setIntervalMinute(this.minuteAdd, 6e4, this.minuteDOM, "分钟", 60, this.hourDOM),
    this.setIntervalHour(this.hourAdd, 144e4, this.hourDOM, "小时", 24, this.dayDOM),
    this.setIntervalday(this.dayAdd, 3456e4, this.dayDOM, "天", 10),
    this.init = function() {
        this.loadtotal()
    }
}
...
function showMedalInfo(t, e) {
    ...
    i += "<dt><img src='" + n.replace(".png", "") + "middle.png' /></dt>",
    i += "<dd><strong>" + a + "</strong>" + s + "</dd>",
    i += "</dl>",
    ...
    __mm_intro.style.top = o.top + 32 + 4 + "px",
    __mm_intro.innerHTML = i,
    document.body.appendChild(__mm_intro)
}
function hideMedalInfo() {
    setTimeout(function() { ! __mm_over && __mm_intro && (document.body.removeChild(__mm_intro), __mm_intro = null)
    },
    500)
}
var csdn = csdn || {};
csdn.SwapImage = function() {
    function t(t) {
        this.imgArray = t.swapRoot.find(".J_adv"),
...
function() {
    ...
    var n = null,
    a = "";
    $("#coins_table").length > 0 ? (e(), i(), n = setInterval(function() {
        e()
    },
    6e4)) : clearInterval(n)
} (),
$(function() {
    ...
    function i(i, n) {
        ...
        $.ajax({
            ...
            success: function(i) {
                ...
                $(".feed_loading").hide(),
                "true" !== i.status ? (window.not_loading = !1, setTimeout(function() {
                    window.not_loading = !0
                },
                3e3)) : (s = i, o = s.articles.length, window.offset = i.shown_offset, o > 0 && (getList(r, s, d, !1,
                function(t) {
                    $(".feedlist_mod").append(t)
                }), prompt()), t(), window.not_loading = !0)
            },
            error: function(t) {
                window.not_loading = !1,
                setTimeout(function() {
    ...
    function() {
        ...
        var e = 300,
        a = (new Date).getTime();
        l || (a - d > 5 * e && (t(), d = a), l = setTimeout(function() {
            l = null,
            d = (new Date).getTime(),
            t()
        },
...
var listAdFun = function() {
    ...
    n = {
        judgementAdId: function(t, e) {
            t += 1,
            "home" === _category ? 3 !== t && 8 !== t && 14 !== t && 21 !== t && 28 !== t && 35 !== t || (this.apendAdItem(t, e), this.adShow()) : 3 !== t && 8 !== t && 14 !== t && 21 !== t || (this.apendAdItem(t, e), this.adShow())
        },
        apendAdItem: function(n, a) {
            var s = _category,
            o = 0;
            switch (s) {
            case "home":
            ...
            default:
                o = i[t]["default"][n]
            } ("new" === a ? e.find("li.tip_box") : e)["new" === a ? "before": "append"]('<ins data-revive-zoneid="' + o + '" data-revive-id="8c38e720de1c90a6f6ff52f3f89c4d57"></ins>')
        },
        adShow: function() {
        ...
        countItemLen: function() {
            var t = e.find("li[data-type]").length,
            i = e.find("ins").length,
            t = i + t;
            return t
        }
...
$.fn.fixedDiv = function(t, e) {
    function i() {
        ...
        n > l - o ? (a.addClass(t), a.css({
            left: d,
            width: c
        })) : (a.removeClass(t), a.css({
            left: 0,
            width: c
        }))
    }
    ...
    o = s * e,
    r = $(".feedlist_mod"),
    l = r.length > 0 ? r.offset().top: null,
    d = $("main").offset().left,
    c = $("main").width();
    r.length > 0 && i(),
...
$(function() {
    ...
    function n(t, e) {
        function i(t) {
            if (t > 0) {
                if (t < 60) $(".btn-feed-refresh").text(t + "分钟前阅读到这里，点击刷新");
                else if (t >= 60 && t < 120) $(".btn-feed-refresh").text("1小时前阅读到这里，点击刷新");
                else if (t >= 120) return $(".btn-feed-refresh").text("2小时前阅读到这里，点击刷新"),
    ...
    var r = n(o, null);
    $(".tip_box").show(),
    $(document).on("click", ".btn-feed-refresh",
    function() {
        s.click(),
        $("div.feed-loading-box").show(),
        i("new"),
...
fix_right = function() {
    ...
    i = e.width(),
    n = $("aside").offset().left,
    a = ($("aside").height(), $(".fixed24").offset().top);
    $(window).on("scroll", t),
    $(window).on("resize",
    function() {
        n = $("aside").offset().left,
...
addLoadEvent(fix_right),
function() {
    function t(t) {
        function e() {
            r < 0 && parseInt(o.offsetTop) > i || r > 0 && parseInt(o.offsetTop) < i ? (o.style.top = parseInt(o.offsetTop) + r + "px", s = setTimeout(e, a)) : (clearInterval(s), o.style.top = i + "px", i <= -o.clientHeight && (o.style.top = "0px"))
        }
    ...
    if (n) {
        var a, s, o = document.getElementById("friendship_link"),
        r = 0,
...
function(t) {
    function e() {
        ...
        e && (e.setAttribute("aria-hidden", "true"), e.style.position = "absolute", e.style.width = 0, e.style.height = 0, e.style.overflow = "hidden", r(e, document.body))
    }
