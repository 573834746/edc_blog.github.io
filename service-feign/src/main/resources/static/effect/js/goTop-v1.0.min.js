!function() {
    ...
    $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
        href: i + "//csdnimg.cn/public/common/gotop/css/goTop.min.css?v20180822133540"
    }).appendTo("head");
    ...
    var d = function(i) {
        if (n = !0, void 0 !== i && "object" == typeof i && $.extend(e, i), e.hasReport) if (null === e.reportFun) console.warn("请设置内容举报方法");
            ...
            var d = $('<a href="#" id="reportContent" class="btn-meau" title="举报">                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22"><path d="M0 13.028V3.365L9 0l9 3.365v9.663C18 17.983 13.97 22 9 22s-9-4.017-9-8.972zm2-8.282v8.282c0 3.854 3.134 6.978 7 6.978s7-3.124 7-6.978V4.746L9 2.13 2 4.746zm6 10.276h2v1.993H8v-1.993zm0-8.973h2v6.979H8V6.049z" fill="#FFF" fill-rule="nonzero"/></svg>                          </a>');
            s.append(d),
            d.click(function(o) {
                o.preventDefault(),
                e.reportFun()
        ...
        if (e.hasFreeAd) {
            var r = $('<a href="https://download.csdn.net/vip_code?utm=buyvip" id="adContent" class="btn-meau">                          </a>');
            s.prepend(r)
        }
